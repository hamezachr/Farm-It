                  ...
                  child: Container(
                    ...
                    child: SfCartesianChart(
                      ...
                      series: <CartesianSeries>[
                        ...
                        SplineSeries<DataPointTemp, int>( // Fixed data type to match hour type (int)
                          name: 'Temperateur',
                          dataSource: Tdata,
                          splineType: SplineType.clamped,
                          xValueMapper: (DataPointTemp point, _) => point.hour.toInt(), // Convert hour to int
                          yValueMapper: (DataPointTemp point, _) => point.temperateur,
                        ),
                      ],
                    ),
                  ),
              ...
              Card(
                ...
                child: Container(
                  ...
                  child: SfCartesianChart(
                    ...
                    series: <CartesianSeries>[ // Change this line to use CartesianSeries
                      AreaSeries<DataPointDP, double>(  // Correct type for AreaSeries
                        dataSource: DPdata,
